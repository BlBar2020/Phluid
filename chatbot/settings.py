...
SECRET_KEY = "django-insecure-w)g+92u*-l&y$+(woahl)gjus+sv5@ax34ta)f@j7+3ph_t_v6"
...
# Set the WhiteNoise configuration for serving static files
if not DEBUG:
    MIDDLEWARE = [
...
EMAIL_HOST = 'mail.phluid.ai'  # SMTP server address
EMAIL_PORT = 2504  # Port for sending email (use 465 for SSL)
EMAIL_USE_TLS = True  # Use TLS encryption
EMAIL_HOST_USER = 'blake@phluid.ai'  # Your SMTP server username
EMAIL_HOST_PASSWORD = '$1984Rainbow'  # Your SMTP server password
